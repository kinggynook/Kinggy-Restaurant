...
public class ServiceActivity extends AppCompatActivity {
    ...
    public class MyConnectedFood extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String strJSON) {
            ...
            try {
                ...
                Log.d("11April", "length ===>>> " + jsonArray.length());
    ...
    private void updateToServer() {
        ...
        try {
            ...
            Toast.makeText(this, "Update Order to Server แล้ว", Toast.LENGTH_SHORT).show();

        } catch (Exception e) {

            Toast.makeText(this, "ไม่สามารภเชื่อมต่อ Server ได้", Toast.LENGTH_SHORT).show();
        }

    }   //updateToServer

    private void createSpinner() {
        final String[] deskStrings = {"โต๊ะที่ 1", "โต๊ะที่ 2", "โต๊ะที่ 3", "โต๊ะที่ 4", "โต๊ะที่ 5", "โต๊ะที่ 6", "โต๊ะที่ 7", "โต๊ะที่ 8", "โต๊ะที่ 9", "โต๊ะที่ 10"};
